                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            ...
                            <input type="Email_usuario" placeholder="Ingresa tu correo" 
                            name='Email_usuario'
                            value={form.Email_usuario || ""} onChange={handleChange}
                        ...
                        <div className="mb-3">
                            ...
                            value={form.Password_usuario || ""} onChange={handleChange}
                            className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-2 text-gray-500" />
                        </div>
                    ...
                    */}
                    ...
                    <div className="mt-3 text-sm flex justify-between items-center">
                        ...
                        <Link to="/registro" className="py-2 px-5 bg-gray-600 text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900 hover:text-white">Registro</Link>
